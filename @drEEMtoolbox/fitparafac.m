...
if matches(mode,"fitsplits")
    ...
    if isempty(C)
        message=[' Could not auto-validate <strong>any</strong> models in the dataset.\n\n' ...
            '   Most likely, <strong>none</strong> of your models finished running in one of the splits or the overall dataset.' ...
            ' Investigate by calling "drEEMtoolbox.viewmodels(samples)" and/or "drEEMtoolbox.viewmodels(samples.split(n))" (replace n with an index for every split),' ...
            ' paying close attention to the percentage of unconverged models in the overview table.\n\n' ...
            '   Often, this scenario can be prevented by:\n' ...
            '        - fixing prevailing data quality issues\n' ...
            '        - increasing the number of starts\n' ...
            '        - increasing the maximum number of iterations\n' ...
            '        - reasonably increasing the convergence criterion (if it was lower than 1e-8)'];
