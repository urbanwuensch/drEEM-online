...
%
%XCorr=nway.tools.setnans1(X,ExMin,ExMax,EmMin,EmMax,WidthMin,WidthMax,Value,MaxOrder,Mode);
%
...
for order=1:MaxOrder
   ...
   for excount=1:a
      ...
      rangemin = find(emax<=(exc-W), 1, 'last' );
      rangemax = find(emax>=(exc+W), 1, 'first' );
