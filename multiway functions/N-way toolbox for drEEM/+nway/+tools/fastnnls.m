...
% March 25, 2017. Changed itmax to a low number because it sometimes just
% runs to itmax without actually changing solution (when z is small but
% positive)
...
iter = 0;
% Low, but that's ok, for iterative algorithms
itmax = 3*n;
