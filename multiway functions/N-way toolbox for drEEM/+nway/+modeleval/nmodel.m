...
%
% function [Xm]=nway.modeleval.nmodel(Factors,G,Om);
%
% This algorithm requires access to:
% 'neye.m'
%
%
% [Xm]=nway.modeleval.nmodel(Factors,G,Om);
%
...
if Orthomode==0,
    ...
    for c=2:N,
        if Fac_orig(c)~=-1,
            ...
            Zm(1:Facprodc1,1:DimXprodc1)=nway.tools.ckron(A',Zm(1:Facprodc0,1:DimXprodc0));
