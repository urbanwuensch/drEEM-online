% N-way toolbox for drEEM
% Version 3.6 August-2025
% For more information, see the <a href="matlab: 
% web('https://ucphchemometrics.com/nway/')">Chemometrics Group of University of Copenhagen</a>.

% This version of the N-way toolbox was forked from N-way version 3.5,
% downloaded in August 2025 from https://ucphchemometrics.com/nway/
% It is a namespace-centered implementation of the toolbox to improve
% consistency and function naming issues.
% Functionally, the toolbox is identical.
