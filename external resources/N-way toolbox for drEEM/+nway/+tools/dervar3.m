...
%
%function dC=nway.tools.dervar3(C,n)
%
...
%----------------------------------------------------------------------------------------
%function  dC=nway.tools.dervar3(C,W,n)
%
%%function dC=nway.tools.dervar3(C,W,n)
%
%%This function determines the derivative of the nth mode of
...
%         for i=1:W(2),
%            for j=1:W(3),
%               [idxia idxja]=nway.tools.getindxn(W,[a i j]);
%               [idxib idxjb]=nway.tools.getindxn(W,[b i j]);
...
%         for i=1:W(1),
%            for j=1:W(3),
%               [idxia idxja]=nway.tools.getindxn(W,[i a j]);
%               [idxib idxjb]=nway.tools.getindxn(W,[i b j]);
%               dc = dc + (C(idxia,idxja)^2 - mc)*C(idxib,idxjb)*C(idxia,idxja);
%            end;
%         end;
%         
...
%         for i=1:W(1),
%            for j=1:W(2),
%               [idxia idxja]=nway.tools.getindxn(W,[i j a]);
%               [idxib idxjb]=nway.tools.getindxn(W,[i j b]);
%               dc = dc + (C(idxia,idxja)^2 - mc)*C(idxib,idxjb)*C(idxia,idxja);
%            end;
%         end;
%         
