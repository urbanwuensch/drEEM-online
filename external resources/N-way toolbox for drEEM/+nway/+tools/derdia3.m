...
%---------------------------------------------------------------------------------------
%function  dC=nway.tools.derdia3(C,W,n)
%
%function dC=nway.tools.derdia3(C,W,n)
%
%%This function determines the derivative of the nth mode of
...
%  for a=1:W(1),
%    for b=1:W(1),
%      [idxia idxja]=nway.tools.getindxn(W,[a a a]);
%      [idxib idxjb]=nway.tools.getindxn(W,[b a a]);
...
%    for b=1:W(2),
%      [idxia idxja]=nway.tools.getindxn(W,[a a a]);
%      [idxib idxjb]=nway.tools.getindxn(W,[a b a]);
%      dC(a,b) = C(idxib,idxjb)*C(idxia,idxja);
%    end;
%  end;
%end;           	
...
%    for b=1:W(3),
%      [idxia idxja]=nway.tools.getindxn(W,[a a a]);
%      [idxib idxjb]=nway.tools.getindxn(W,[a a b]);
%      dC(a,b) = C(idxib,idxjb)*C(idxia,idxja);
%    end;
%  end;
%end;