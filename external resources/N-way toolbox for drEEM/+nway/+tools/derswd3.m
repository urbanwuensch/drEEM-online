...
%
%function dC=nway.tools.derswd3(C,W,n)
%
...
%         dC(a,b)=0;
%         for i_n=1:W(3),
%            [idxia idxja]=nway.tools.getindxn(W,[a a i_n]);
%            [idxib idxjb]=nway.tools.getindxn(W,[b a i_n]);
...
%         for i_n=1:W(3),
%            [idxia idxja]=nway.tools.getindxn(W,[a a i_n]);
%            [idxib idxjb]=nway.tools.getindxn(W,[a b i_n]);
%            dC(a,b) = dC(a,b) + C(idxib,idxjb)*C(idxia,idxja);
%         end;
%      end;
%   end;           	
...
%         dC(a,b)=0;
%         for i=1:W(1),
%            [idxia idxja]=nway.tools.getindxn(W,[i i a]);
%            [idxib idxjb]=nway.tools.getindxn(W,[i i b]);
